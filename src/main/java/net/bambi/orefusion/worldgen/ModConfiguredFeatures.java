...
public class ModConfiguredFeatures {
        ...
        // END_BLACK_OPAL_ORE_KEY = registerKey(
        // "end_black_opal_ore");
        // public static final ResourceKey<ConfiguredFeature<?, ?>>
        // NETHER_BLACK_OPEL_ORE_KEY = registerKey(
        // "nether_black_opal_ore");
        ...
        public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> context) {
                ...
                register(context,
                                OVERWORLD_PHOSPHATE_ORE_KEY, Feature.ORE,
                                new OreConfiguration(overworldPhosphateOres, 120));
        }
