...
import net.bambi.orefusion.screen.renderer.EnergyInfoArea;
import net.bambi.orefusion.screen.renderer.FluidTankRenderer;
import net.bambi.orefusion.util.MouseUtil;
...
public class GemInfusingStationScreen extends AbstractContainerScreen<GemInfusingStationMenu> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(OreFusion.MOD_ID,
