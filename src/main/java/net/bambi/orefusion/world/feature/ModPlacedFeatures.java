...
public class ModPlacedFeatures {
        ...
        public static final ResourceKey<PlacedFeature> ZIRCON_PLACED_KEY = createKey("phosphate_placed");
        // public static final ResourceKey<PlacedFeature> END_ZIRCON_PLACED_KEY =
        // createKey("end_phosphate_placed");
        // public static final ResourceKey<PlacedFeature> NETHER_ZIRCON_PLACED_KEY =
        // createKey("nether_phosphate_placed");

        public static final ResourceKey<PlacedFeature> ZIRCON_GEODE_PLACED_KEY = createKey("phosphate_geode_placed");
        ...
        public static void bootstrap(BootstapContext<PlacedFeature> context) {
                ...
                register(context, RED_MAPLE_CHECKED_KEY,
                ...
                // configuredFeatures.getOrThrow(ModConfiguredFeatures.NETHER_PHOSPHATE_ORE_KEY),
                // commonOrePlacement(12, // VeinsPerChunk
                // HeightRangePlacement.uniform(VerticalAnchor.aboveBottom(-80),
                // VerticalAnchor.aboveBottom(80))));
                // register(context, END_ZIRCON_PLACED_KEY,
                // configuredFeatures.getOrThrow(ModConfiguredFeatures.END_PHOSPHATE_ORE_KEY),
                // commonOrePlacement(12, // VeinsPerChunk
                // HeightRangePlacement.uniform(VerticalAnchor.aboveBottom(-80),
                // VerticalAnchor.aboveBottom(80))));
                ...
                register(context, JASMINE_PLACED_KEY,
                                configuredFeatures.getOrThrow(ModConfiguredFeatures.JASMINE_KEY),
