...
public class ModConfiguredFeatures {
        ...
        // END_PHOSPHATE_ORE_KEY = registerKey(
        // "end_phosphate_ore");
        // public static final ResourceKey<ConfiguredFeature<?, ?>>
        // NETHER_PHOSPHATE_ORE_KEY = registerKey(
        // "nether_phosphate_ore");

        public static final ResourceKey<ConfiguredFeature<?, ?>> ZIRCON_GEODE_KEY = registerKey("phosphate_geode");
        ...
        // END_PHOSPHATE_ORES = Suppliers
        // .memoize(() -> List.of(
        // OreConfiguration.target(new BlockMatchTest(Blocks.END_STONE),
        // ModBlocks.ENDSTONE_PHOSPHATE_ORE.get().defaultBlockState())));
        // public static final Supplier<List<OreConfiguration.TargetBlockState>>
        // NETHER_PHOSPHATE_ORES = Suppliers
        // .memoize(() -> List.of(
        // OreConfiguration.target(new BlockMatchTest(Blocks.NETHERRACK),
        // ModBlocks.NETHERRACK_PHOSPHATE_ORE.get().defaultBlockState())));
        ...
        public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> context) {
                ...
                // register(context, END_PHOSPHATE_ORE_KEY, Feature.ORE,
                // new OreConfiguration(END_PHOSPHATE_ORES.get(), 12));
                // register(context, NETHER_PHOSPHATE_ORE_KEY, Feature.ORE,
                // new OreConfiguration(NETHER_PHOSPHATE_ORES.get(), 12));

                register(context, ZIRCON_GEODE_KEY, Feature.GEODE,
                                new GeodeConfiguration(new GeodeBlockSettings(BlockStateProvider.simple(Blocks.AIR),
                                                BlockStateProvider.simple(Blocks.DEEPSLATE),
                                                BlockStateProvider.simple(ModBlocks.PHOSPHATE_ORE.get()),
                                                BlockStateProvider.simple(Blocks.DIRT),
                                                BlockStateProvider.simple(Blocks.EMERALD_BLOCK),
                                                List.of(ModBlocks.PHOSPHATE_BLOCK.get().defaultBlockState()),
                ...
                register(context, JASMINE_KEY, Feature.FLOWER,
                                new RandomPatchConfiguration(32, 6, 2, PlacementUtils.onlyWhenEmpty(
                                                ...
                                                new SimpleBlockConfiguration(
                                                                BlockStateProvider.simple(ModBlocks.JASMINE.get())))));
        }

        public static ResourceKey<ConfiguredFeature<?, ?>> registerKey(String name) {
                return ResourceKey.create(Registries.CONFIGURED_FEATURE,
                                new ResourceLocation(OreFusion.MOD_ID, name));
        }
