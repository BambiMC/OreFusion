package net.bambi.orefusion.world.village;
...
public class VillageAddition {
         ...
         * We will call this in addNewVillageBuilding method further down to add to
         * every village.
         *
         ...
         * JSON worldgen files were parsed.
        ...
        public static void addNewVillageBuilding(final ServerAboutToStartEvent event) {
                ...
                addBuildingToPool(templatePoolRegistry, processorListRegistry,
                                ...
                                "orefusion:plains_jump_master", 250);
